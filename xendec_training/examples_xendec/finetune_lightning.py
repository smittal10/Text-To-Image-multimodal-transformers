...
from dataset_xendec import CocoDataset, collate_fn_double_input
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from dalle_xendec.models import Dalle
from dalle_xendec.utils.utils import set_seed
...
class ImageNetDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.trainset,
                          ...
                          shuffle=True,
                          collate_fn=collate_fn_double_input)
